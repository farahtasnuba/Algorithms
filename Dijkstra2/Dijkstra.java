...
public class Dijkstra {
    ...
    public static void main(String[] args){
        ...
        vertices[0] = new Vertex("0", 1, 2);
        graph.addVertex(vertices[0], true);
        
        vertices[1] = new Vertex("1", 3, 4);
        graph.addVertex(vertices[0], true);
        
        vertices[2] = new Vertex("2", 1, 2);
        graph.addVertex(vertices[0], true);
        
        vertices[3] = new Vertex("3", 1, 2);
        graph.addVertex(vertices[0], true);
        
        vertices[4] = new Vertex("4", 1, 2);
        graph.addVertex(vertices[0], true);
        
        vertices[5] = new Vertex("5", 1, 2);
        graph.addVertex(vertices[0], true);
